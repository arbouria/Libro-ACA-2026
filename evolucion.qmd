...
Para profundizar en los conceptos de este capítulo, hemos preparado un simulador. 

Haz clic en el siguiente enlace para abrirlo y sigue las instrucciones de la introducción para dirigirse al simulador 2:

[**Abrir Simuladores en Google Colab**](https://colab.research.google.com/github/arbouria/Libro-ACA-2026/blob/main/Simuladores/selección_natural.ipynb){target="_blank"}
...
Haz clic en el siguiente enlace para abrirlo y sigue las instrucciones de la introducción para dirigirse al simulador 3:
...
Haz clic en el siguiente enlace para abrirlo y sigue las instrucciones de la introducción para dirigirse al simulador 4:
