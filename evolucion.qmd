...
Para explorar estos conceptos, abra los [Simuladores en Google Colab](https://colab.research.google.com/github/arbouria/Libro-ACA-2026/blob/main/Simuladores/selección_natural.ipynb){target="_blank"} y siga las instrucciones
...
Para explorar la covarianza, abra los [Simuladores en Google Colab](https://colab.research.google.com/github/arbouria/Libro-ACA-2026/blob/main/Simuladores/selección_natural.ipynb){target="_blank"} y siga las instrucciones de la introducción para dirigirse al simulador 3.
...
Para explorar el cambio evolutivo, abra los [Simuladores en Google Colab](https://colab.research.google.com/github/arbouria/Libro-ACA-2026/blob/main/Simuladores/selección_natural.ipynb){target="_blank"} y siga las instrucciones de la introducción para dirigirse al simulador 4.
