...
Que es exactamente la regla delta. Pero ahora podemos expandir recursivamente para ver qué peso recibe cada refuerzo pasado. La tabla siguiente muestra los primeros tres pasos de la sustitución con $V_0 = 0$:
