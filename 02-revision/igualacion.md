...
![FIGURA 14.1: Diagrama esquemático de un programa concurrente de dos teclas para palomas. Ambas teclas están disponibles simultáneamente durante toda la sesión](Figuras/fig_14_1_camara_concurrente.png){#fig_14_1_camara_concurrente.png width=750 fig-align="center"}

::: {.callout-note collapse="true" appearance="minimal"}
*[Diagrama esquemático de un programa concurrente de dos teclas para palomas]*
:::
...
> **[SIMULADOR 14.3 — Programas Concurrentes RV-IV: ¿Rentabilidad o Maximización?]**
>
...
>
> **Ejercicio 1 (básico):** Con los parámetros por defecto (RV 10, IV 30 respuestas), ¿a qué equilibrio converge cada organismo? Compara el del organismo de igualación con el equilibrio teórico que calcula el simulador ($f_{IV} = n_{RV}/t_{IV}$). Lee el "costo de igualar" en el panel de refuerzos acumulados y anótalo.
>
> **Ejercicio 2 (intermedio):** Antes de correr: si cambias el IV de 30 a 60 respuestas, ¿qué le debería pasar al equilibrio de igualación según la fórmula? Corre la simulación con IV = 60. ¿Cambia el costo de igualar? ¿En qué dirección y por qué?
>
> **Ejercicio 3 (intermedio):** Establece n_RV = 30 (RV más pobre). ¿Para qué valor de n_RV la predicción de igualación y la de maximización coincidirían? ¿Qué dice eso sobre cuándo el diseño RV-IV puede discriminar entre las dos hipótesis?
>
> **Ejercicio 4 (avanzado):** Observa el panel de rentabilidades durante las primeras 500 respuestas, cuando el organismo de igualación todavía está cerca de 50/50. ¿Cuál de las dos opciones es más rentable en ese momento? ¿Es coherente con la dirección en que el melioration ajusta p_RV?
>
> **Ejercicio 5 (avanzado):** Aumenta α a 0.28. ¿Converge el organismo de igualación de forma limpia o hay oscilaciones en el panel de rentabilidades? ¿Qué dice esto sobre la relación entre velocidad de ajuste y precisión del equilibrio?
