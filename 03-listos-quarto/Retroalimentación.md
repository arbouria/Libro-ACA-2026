...
**[FIGURA 5.1: Trayectorias de fototaxia positiva y negativa. Izquierda: el organismo se aproxima a la fuente de luz con una trayectoria en espiral. Derecha: el organismo se aleja de ella con el mismo patrón. La fuente de luz (flecha) viene de la izquierda. El movimiento en espiral es característico de la comparación simultánea: el error se va reduciendo gradualmente conforme el organismo se orienta.]**
...
**[FIGURA 5.2: Trayectorias con un ojo cubierto. Filas: oscuridad, luz arriba, haz de luz. Columnas: ojo izquierdo ciego vs. ojo derecho ciego. Con un solo ojo funcional, el organismo gira continuamente en lugar de orientarse. La dirección del giro depende de qué ojo está disponible y del tipo de taxia (positiva/negativa).]**
...
**[FIGURA 5.3: Trayectorias de cochinilla con dos fuentes equidistantes. Las trayectorias reales muestran movimiento en línea recta entre las dos fuentes y el brusco cambio de dirección al acercarse a una de ellas. La línea recta ocurre porque la diferencia bilateral es cero cuando las fuentes son equidistantes.]**
...
**[FIGURA 5.4: Diagrama del sistema de retroalimentación. Dos cajas en lazo cerrado: arriba, la función del organismo O(x) que transforma el estímulo controlador x en una respuesta y; abajo, la función del entorno E(y) que transforma la respuesta y en el valor de x. La flecha de y a E(y) y de E(y) de regreso a x cierra el lazo.]**
...
**[FIGURA 5.5: Diagrama de retroalimentación con componentes nombrados. Desired Output → Comparator → Error signal → Effectors (calefactor/AC) → Output, con Sensor + Feedback signal completando el lazo. El comparador integra la salida deseada con la señal de retroalimentación del sensor para producir la señal de error.]**

**[FIGURA 5.6: Diagrama específico para la mariposa. Set point (45°) → Comparador (E_Angle) → Controller (Flying Decision-making circuit) → Actor (Wing) → Flying, con Sensor (Compound eyes) + señal de Angle cerrando el lazo. Los ángulos y nombres de señales corresponden a las variables del sistema real.]**
...
**[FIGURA 5.7: Trayectorias reales de polillas. Panel izquierdo: trayectoria circular cuando solo hay un eje de estimulación disponible. Panel derecho: trayectoria en zigzag de aproximación mostrando la dinámica de convergencia. Son datos empíricos, no ilustraciones.]**
...
**[FIGURA 5.8: Gráfica de Transitorio vs. Estado Estacionario. Eje x: tiempo. Eje y: comportamiento. La fase transitoria muestra ajuste gradual hacia el Steady State. Una perturbación abrupta produce un nuevo transitorio. El sistema recupera el equilibrio en ambos casos.]**
...
**[SIMULADOR AQUÍ — Organismo con dos sensores laterales navegando hacia fuente de luz. Parámetros: ganancia k, ángulo inicial θ₀, tipo de taxia (positiva/negativa). Visualización: trayectoria en el espacio y ángulo θ en el tiempo. Experimento disponible: cubrir un ojo.]**
...
**[SIMULADOR AQUÍ — Sistema de fototaxia con demora ajustable entre detección de error y ejecución de respuesta. Parámetros: ganancia k, delay en pasos de tiempo. Visualización: ángulo θ vs. tiempo mostrando convergencia suave vs. oscilaciones.]**
...
**[SIMULADOR AQUÍ — Dos conductores en una ruta de 500 km con gasolineras distribuidas irregularmente. Conductor reactivo: carga cuando el tanque alcanza 15%. Conductor anticipatorio: carga antes de tramos largos. Parámetros: distribución de gasolineras, autonomía del tanque, umbral reactivo. Visualización: posición vs. nivel de tanque para cada conductor.]**
