...
**[FIGURA 6.1: Los protocolos temporales del condicionamiento clásico. Eje horizontal: tiempo. Barras sólidas: duración de cada estímulo. De arriba a abajo: condicionamiento de demora con intervalo corto (máximo aprendizaje), condicionamiento de demora con intervalo largo, condicionamiento de huella, condicionamiento hacia atrás (mínimo aprendizaje). La flecha indica la dirección del gradiente de demora.]**
...
**[FIGURA 6.2: Diseño del experimento de García y Koelling. Fase de entrenamiento (arriba): todos los animales reciben el compuesto sabor+audiovisual; la mitad recibe descarga eléctrica inmediata, la otra mitad malestar gastrointestinal diferido por horas. Fase de prueba (abajo): se presentan por separado el sabor solo y el estímulo audiovisual solo. Las barras muestran la supresión de la respuesta de beber. Las ratas con descarga eléctrica evitan el estímulo audiovisual pero no el sabor; las ratas con malestar gastrointestinal evitan el sabor pero no el estímulo audiovisual.]**
...
### Hacia adelante: Rescorla-Wagner y la Competencia entre Estímulos (Capítulo 9)

El modelo de Bush y Mosteller captura el error de predicción para un estímulo en solitario, pero no deriva el bloqueo. El bloqueo requiere algo adicional: que el error de predicción no se calcule sobre el valor de un estímulo individual sino sobre la suma de los valores de *todos* los estímulos presentes simultáneamente. Esa extensión —propuesta por Rescorla y Wagner en 1972— convierte la competencia entre estímulos en una consecuencia matemática de la ecuación, no en un supuesto adicional. Cuando A ya predice perfectamente el suceso biológicamente importante, la suma de valores iguala al máximo posible, el error es cero, y B no aprende nada aunque sea perfectamente contiguo. El capítulo 9 examina ese modelo y sus consecuencias, que van bastante más lejos del bloqueo.
