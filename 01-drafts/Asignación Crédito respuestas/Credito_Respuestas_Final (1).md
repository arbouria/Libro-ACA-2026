...
Esta revisión procederá de manera paralela a la que seguimos en el capítulo anterior para estímulos. Primero examinaremos si la contigüidad es suficiente: ¿basta con que una respuesta sea seguida temporalmente por un SBI para que se fortalezca? Skinner diseñó el experimento crucial para probar esta hipótesis. Segundo, preguntaremos si la contigüidad es necesaria: ¿puede ocurrir aprendizaje cuando hay demoras sustanciales entre respuesta y reforzador? Los experimentos de Dickinson, Hammond y Lattal proporcionan respuestas sorprendentes. Finalmente, exploraremos cómo los organismos discriminan entre contigüidades genuinamente causales y meramente accidentales—un problema de detección de señales que Killeen formalizó brillantemente. A través de esta secuencia, veremos emerger los mismos temas que encontramos para estímulos: la contigüidad no es ni necesaria ni suficiente, y los sesgos inductivos—en este caso, sistemas de comportamiento y conducta inducida—estructuran el espacio de búsqueda para hacer el problema tratable.
...
La demostración de que la conducta en protocolos de "superstición" no es arbitraria sino estructurada por sistemas de comportamiento resuelve decisivamente nuestra pregunta sobre la suficiencia de la contigüidad: la mera proximidad temporal entre una respuesta y un SBI no es suficiente para producir aprendizaje instrumental genuino. Las conductas que emergen no son producto de asociaciones accidentales sino de arquitecturas conductuales preexistentes activadas por el SBI. Pero resolver esta pregunta sobre suficiencia nos deja con la pregunta complementaria igualmente importante: si la contigüidad no es suficiente, ¿es al menos necesaria? ¿Requiere el aprendizaje instrumental que la respuesta y el reforzador ocurran en proximidad temporal estrecha, o pueden los organismos detectar relaciones causales incluso a través de demoras sustanciales que violan cualquier definición razonable de contigüidad? Esta pregunta nos conduce a examinar un conjunto de experimentos que desafiaron suposiciones fundamentales sobre el papel del tiempo en el aprendizaje.
...
Esta conclusión plantea una pregunta más fundamental sobre la naturaleza de los juicios causales en organismos no-humanos. Si los organismos pueden detectar contingencias estadísticas a largo plazo que son independientes de contigüidades momento a momento, esto sugiere que poseen algún mecanismo para evaluar relaciones causales de manera más sofisticada que la simple asociación temporal. Pero ¿cuán sofisticado es este mecanismo? ¿Pueden los organismos discriminar activamente entre eventos que sus acciones causaron versus eventos que ocurrieron independientemente de sus acciones? Y si pueden hacer esta discriminación, ¿cómo la hacen? ¿Es un proceso perceptual automático, o involucra algún tipo de proceso de decisión que pesa costos y beneficios?

Estas preguntas nos llevan más allá del dominio tradicional del análisis conductual hacia el estudio de la percepción de causalidad—cómo los organismos infieren relaciones causales a partir de patrones de covariación en su experiencia. Este es un problema que conecta el aprendizaje operante con la psicología cognitiva y con marcos formales de la teoría de detección de señales. Los experimentos que examinaremos ahora demuestran que los organismos no solo son sensibles a contingencias, sino que ajustan activamente sus juicios de causalidad basándose en la estructura de incentivos del ambiente, revelando una flexibilidad adaptativa que va mucho más allá de lo que podría esperarse de mecanismos de asociación simples.
...
**1. Análisis de la Ley del Efecto**

La Ley del Efecto de Thorndike establece que respuestas seguidas de "estados de cosas satisfactorios" se fortalecen en su conexión con el estímulo precedente.

a) Identifique tres problemas conceptuales o ambigüedades en esta formulación original que requirieron refinamiento teórico posterior. Para cada problema, explique por qué representa una limitación significativa para una teoría completa del aprendizaje instrumental.

b) Thorndike observó que el tiempo de escape disminuía gradualmente a través de ensayos, no abruptamente. ¿Qué implica este patrón gradual sobre el mecanismo subyacente? Compare con un mecanismo hipotético de aprendizaje "todo-o-nada" y explique cuál es más consistente con los datos.

c) En los experimentos de Thorndike, los gatos mostraban menos respuestas incorrectas conforme progresaban los ensayos. Distinga entre dos posibles explicaciones: (i) las respuestas incorrectas se "debilitan" activamente, versus (ii) la respuesta correcta se fortalece tanto que domina la conducta sin que las incorrectas necesariamente se debiliten. ¿Cómo podrían estas alternativas producir el mismo patrón observado? ¿Qué experimento diseñaría para distinguirlas?

**2. Reinterpretando la "Superstición"**

Skinner interpretó la conducta de sus palomas como producto de contigüidad accidental entre respuestas arbitrarias y la entrega de comida. Staddon & Simmelhag ofrecieron una reinterpretación radical.

a) Explique por qué el término "superstición" implica que las respuestas observadas son arbitrarias o accidentales. ¿Qué aspecto del protocolo experimental de Skinner lo llevó a esta conclusión?

b) Staddon & Simmelhag distinguieron entre conducta "terminal" e "interina". Defina ambos términos y explique cómo esta distinción desafía la interpretación de Skinner. ¿Por qué la existencia de patrones sistemáticos de conducta (no arbitrarios) es problemática para la teoría de contigüidad accidental?

c) Considere un organismo en un protocolo de tiempo fijo (comida cada 20 segundos sin contingencia). Si la contigüidad accidental fuera el mecanismo dominante, ¿qué predicción haría sobre la variabilidad de las conductas observadas entre diferentes sujetos? ¿Qué predicción hace la teoría de conducta inducida? Use esto para argumentar cuál teoría es más parsimoniosa.

**3. Predicciones desde Sistemas de Comportamiento**

El concepto de conducta inducida sugiere que los SBI activan sistemas de comportamiento específicos que generan repertorios característicos de respuestas.

a) Diseñe mentalmente un protocolo de tiempo fijo donde el SBI es acceso a agua (no comida). Basándose en la teoría de sistemas de comportamiento, prediga qué tipos de conductas interinas y terminales esperaría observar. Justifique sus predicciones en términos del sistema de comportamiento activado (ingestión de agua vs. ingestión de comida).

b) Ahora considere un SBI aversivo: escape de ruido blanco intenso. ¿Qué sistema de comportamiento se activaría? ¿Qué conductas interinas y terminales predice? ¿Cómo difieren de las predichas para comida o agua?

c) La teoría predice que las conductas inducidas no son arbitrarias sino funcionalmente relacionadas al sistema activado. Explique cómo esta predicción hace a la teoría falsable. ¿Qué patrón de resultados refutaría la teoría de sistemas de comportamiento?

**4. Contigüidad versus Contingencia: Disociación Experimental**

Los experimentos de Hammond, Dickinson y Lattal demostraron que la contigüidad no es suficiente para el aprendizaje instrumental.

a) En el experimento de Hammond (1980), los sujetos recibían comida tanto contingente a presionar la palanca como no-contingente (independiente de la respuesta). Explique cómo este diseño permite separar los efectos de contigüidad (proximidad temporal) de contingencia (relación causal estadística). ¿Qué patrón de resultados demostraría que la contingencia, no la contigüidad, controla el aprendizaje?

b) Dickinson et al. (1992) usaron demoras entre la respuesta y el reforzador de hasta 64 segundos. Si la contigüidad temporal fuera necesaria, ¿qué resultado esperaría con demoras de 64 segundos? ¿Qué observaron realmente? ¿Qué mecanismo proponen para explicar el aprendizaje a pesar de la demora?

c) Lattal & Gleeson (1990) presentaban reforzadores demorados pero también reforzadores "espurios" inmediatamente después de respuestas incorrectas. Explique la lógica de este control: ¿qué aspecto de la contigüidad están controlando? Si los organismos fueran sensibles solo a contigüidad, ¿qué aprenderían? ¿Qué aprendieron realmente?

**5. Marcos Moleculares versus Molares**

Baum distingue entre análisis molecular (momento a momento) y molar (agregado, a largo plazo) del comportamiento.

a) Defina operacionalmente lo que constituye un análisis "molecular" versus uno "molar" en el contexto del condicionamiento instrumental. Proporcione ejemplos concretos de medidas o variables dependientes características de cada enfoque.

b) El fenómeno de "matching" (igualación) en programas concurrentes es mejor descrito molarmente: la proporción de respuestas en dos alternativas iguala la proporción de reforzadores obtenidos. Sin embargo, molecularmente, los organismos no distribuyen respuestas de forma perfectamente proporcional momento a momento. Explique cómo este hallazgo favorece un análisis molar. ¿Qué implica sobre el nivel apropiado de descripción para leyes conductuales?

c) Baum argumenta que la "contigüidad" es un concepto fundamentalmente molecular. Si adoptamos una perspectiva exclusivamente molar, ¿cómo reformularíamos el problema de asignación de crédito para respuestas? ¿Qué variables o relaciones serían relevantes en lugar de contigüidad temporal?

### Ejercicios Cuantitativos

**6. Cálculo de Contingencia y Teoría de Detección de Señales**

Killeen (1978) reinterpretó la "superstición" como un problema de detección de señales donde los organismos deben discriminar entre contingencia real y espuria.

Considere el siguiente escenario: Una paloma en una caja experimental emite una respuesta (R) de picotear a la izquierda. Un reforzador (S) puede o no presentarse. Después de 100 ensayos, se observa:

- R seguida de S (dentro de 2 seg): 15 veces
- R no seguida de S: 35 veces  
- S sin R previa (en los 2 seg anteriores): 5 veces
- Ni R ni S: 45 veces

a) Calcule la probabilidad condicional P(S|R) y P(S|~R). ¿Existe contingencia positiva entre R y S? Muestre sus cálculos.

b) Calcule el índice Φ (phi) de contingencia usando la fórmula:

Φ = P(S|R) - P(S|~R)

Interprete el valor obtenido. ¿Qué magnitud de contingencia existe?

c) Desde la perspectiva de teoría de detección de señales, la paloma enfrenta el problema de decidir si existe relación causal real o si las contigüidades observadas son accidentales. Dibuje una matriz 2×2 de aciertos, falsas alarmas, rechazos correctos y errores. Si la paloma tiene un criterio de decisión "laxo" (baja β), ¿qué tipo de error será más frecuente? ¿Qué implicaciones tiene esto para la "superstición"?

d) Killeen argumenta que organismos con alta motivación (alto costo de omitir un reforzador) deberían tener criterios más laxos. Grafique cualitativamente cómo la curva ROC se desplazaría con diferentes niveles de motivación. ¿Qué predice esto sobre la prevalencia de conducta "supersticiosa" en función de privación de comida?

**7. Análisis Cuantitativo de Conducta Terminal vs. Interina**

Staddon & Simmelhag (1971) registraron la frecuencia de diferentes respuestas en función del tiempo desde el último reforzador en un programa de tiempo fijo de 12 segundos.

Suponga que registró la conducta de picoteo dirigido al comedero en intervalos de 2 segundos. Los datos (frecuencia relativa) son:

| Intervalo | 0-2s | 2-4s | 4-6s | 6-8s | 8-10s | 10-12s |
|-----------|------|------|------|------|-------|--------|
| Frecuencia| 0.05 | 0.08 | 0.12 | 0.15 | 0.25  | 0.35   |

a) Grafique estos datos (frecuencia vs. tiempo). ¿Este patrón corresponde a conducta terminal o interina? Justifique basándose en la definición temporal de cada clase.

b) Calcule la tasa de cambio (pendiente) de la frecuencia entre intervalos consecutivos. ¿La aceleración es constante, creciente, o decreciente conforme se aproxima el reforzador? ¿Qué implica esto sobre el mecanismo temporal subyacente?

c) Ahora suponga que una segunda conducta (caminar en círculos) muestra el patrón opuesto: alta frecuencia en 0-2s (0.40), decreciendo hasta 10-12s (0.05). Si usted solo pudiera observar UNA de estas conductas y el experimentador alegara que se debe a "contigüidad accidental", ¿cómo usaría el análisis temporal para refutar esta interpretación? Sea específico sobre qué aspecto de los datos contradice la hipótesis de contigüidad accidental.

**8. Modelando el Gradiente de Demora en Aprendizaje Instrumental**

El gradiente de demora en condicionamiento instrumental puede aproximarse con una función exponencial decreciente:

Fuerza de aprendizaje = A · e^(-d/τ)

donde A es el aprendizaje con demora cero, d es la demora en segundos, y τ es una constante de tiempo característica del organismo.

a) Si para ratas en un procedimiento de prensa de palanca se ha estimado que τ = 8 segundos y A = 1.0, calcule la fuerza de aprendizaje esperada para demoras de 0, 5, 10, 20, y 40 segundos. Grafique la función.

b) Los experimentos de Dickinson muestran que el aprendizaje sigue ocurriendo con demoras de 64 segundos, aunque debilitado. Si usáramos el modelo exponencial puro, ¿qué fuerza de aprendizaje predice para 64 segundos? Compare con el hecho de que Dickinson observó aprendizaje robusto. ¿Qué sugiere esta discrepancia sobre la naturaleza del mecanismo?

c) Dickinson propone que conductas "mediadoras" (respuestas inducidas que llenan el intervalo de demora) crean "puentes temporales" que efectivamente reducen la demora psicológica. Si una conducta mediadora aparece consistentemente 2 segundos después de la respuesta instrumental, modele el gradiente de demora efectivo bajo esta hipótesis. ¿Cómo cambia la predicción para una demora física de 64 segundos?

### Ejercicios Aplicados

**9. Aplicación Clínica: Análisis de Conductas "Rituales"**

Un niño con Trastorno Obsesivo-Compulsivo desarrolla un ritual elaborado antes de salir de casa: debe tocar el marco de la puerta 7 veces, girar en círculo dos veces, y tocar el marco nuevamente 3 veces. Reporta que si no lo hace, "algo malo pasará". De hecho, cuando omite el ritual, experimenta ansiedad intensa. Cuando lo completa, la ansiedad disminuye.

a) Analice esta conducta desde la perspectiva de asignación de crédito a respuestas. ¿Cuál es el SBI en este caso? ¿La respuesta (el ritual) es realmente causal para el resultado (reducción de ansiedad), o es una contigüidad accidental? ¿Qué tipo de contingencia estadística existe realmente?

b) Aplique la teoría de detección de señales de Killeen a este caso. ¿Por qué el niño mantiene la creencia en la eficacia del ritual a pesar de que objetivamente no previene "cosas malas"? Considere el costo relativo de falsos positivos (hacer el ritual innecesariamente) versus falsos negativos (omitir un ritual "necesario").

c) Diseñe una intervención conductual basada en los principios del capítulo que permita al niño discriminar que el ritual no tiene contingencia real con eventos negativos. Su intervención debe manipular sistemáticamente las probabilidades condicionales P(ansiedad|ritual) y P(ansiedad|~ritual). Especifique el procedimiento paso a paso, las medidas que tomaría, y las predicciones sobre cómo cambiaría la conducta.

**10. Diseño Experimental: Disociando Conducta Terminal de Aprendizaje Instrumental**

Un investigador quiere demostrar que la conducta terminal (ej. picotear cerca del comedero antes de la entrega de comida) no es aprendizaje instrumental genuino sino conducta inducida por activación del sistema de alimentación.

a) Diseñe un experimento con dos grupos de palomas. El Grupo 1 recibe un programa de tiempo fijo (comida cada 20s independiente de respuestas). El Grupo 2 recibe un programa dependiente de omisión (DRO): comida cada 20s solo si NO picotean el comedero en los últimos 5 segundos. Si la conducta terminal fuera aprendizaje instrumental verdadero, ¿qué predicción hace para cada grupo? Si fuera conducta inducida, ¿qué predicción alternativa hace?

b) Especifique las medidas dependientes exactas que registraría. ¿Cómo cuantificaría "conducta terminal"? ¿Qué distribución temporal de respuestas esperaría en cada grupo bajo cada hipótesis?

c) Suponga que encuentra que el Grupo 2 (DRO) muestra reducción de picoteo en los últimos 5 segundos pero lo mantiene en otros momentos del intervalo. ¿Qué implicaría esto? ¿Favorecería la hipótesis de conducta inducida o de aprendizaje instrumental? ¿O sugeriría que ambos procesos operan simultáneamente? Elabore.

**11. Caso de Entrenamiento Animal: El Problema del Truco que Deriva**

Un entrenador de perros de asistencia enseña a un perro a "traer el teléfono" cuando suena. Inicialmente, el perro aprende bien: al sonar el teléfono, va directamente al teléfono, lo toma con la boca, y lo trae. Sin embargo, después de varias semanas, la conducta "deriva": ahora el perro escucha el teléfono, primero corre hacia su tazón de comida, huele el tazón, luego va al teléfono, lo trae, pero también lo sacude vigorosamente antes de entregarlo (conducta de "captura de presa").

a) Use el concepto de conducta inducida y sistemas de comportamiento para explicar esta deriva. ¿Qué sistema de comportamiento se está activando? ¿Por qué las conductas intermedias (ir al tazón, sacudir el teléfono) son consistentes con este sistema?

b) El entrenador decide "reprimir" estas conductas no-deseadas negando el reforzador (premio/comida) cuando el perro exhibe las conductas intermedias. Desde una perspectiva molar vs. molecular, ¿por qué esta estrategia podría ser inefectiva o incluso contraproducente? ¿Qué predice sobre la persistencia de las conductas inducidas?

c) Proponga una estrategia de entrenamiento alternativa que reconozca y trabaje *con* los sistemas de comportamiento activados en lugar de contra ellos. Específicamente, ¿cómo podría rediseñar el contexto o la tarea para que las conductas inducidas naturales sean compatibles con (o incluso faciliten) la conducta meta de traer el teléfono?

**12. Análisis Crítico: Contingencia Percibida en Contextos Humanos**

Los casinos están diseñados para maximizar la percepción de contingencia entre acciones del jugador y resultados (ganar dinero), a pesar de que objetivamente los juegos tienen ventaja para la casa.

a) Analice las máquinas tragamonedas desde la perspectiva de teoría de detección de señales. Identifique al menos tres características del diseño (reforzamiento en razón variable, "casi-aciertos", sonidos/luces con cada jugada) y explique cómo cada una manipula la percepción de contingencia. ¿Cómo distorsionan las probabilidades condicionales percibidas P(ganar|jugar) vs. P(ganar|~jugar)?

b) Los "sistemas" de juego (ej. Martingala: doblar la apuesta tras cada pérdida) son prevalentes a pesar de no cambiar las probabilidades subyacentes. Use los conceptos del capítulo (contigüidad accidental, percepción de causalidad, criterio de decisión) para explicar por qué persisten estas creencias. ¿Qué papel juega la intermitencia del reforzamiento y la variabilidad conductual en mantener estas ilusiones de control?

c) Diseñe un "experimento natural" que podría conducirse en un casino para demostrar que los jugadores son sensibles a contingencias reales, no solo a contigüidades accidentales. ¿Qué manipulación introduciría? ¿Qué patrón de resultados demostraría sensibilidad a contingencia genuina versus respuesta a mera contigüidad? Considere las limitaciones éticas y prácticas de su propuesta.
