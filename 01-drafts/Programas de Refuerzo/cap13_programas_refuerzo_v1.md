...
¿Qué puede explicar este resultado? Se han propuesto dos mecanismos complementarios, no mutuamente excluyentes, que examinamos a continuación.
...
Rachlin (1978) propuso una parametrización elegante que unifica ambos tipos de programa en una sola expresión:
...
**Modelos de Killeen y Baum (capítulo posterior).** Las dos explicaciones de este capítulo — TER molecular y correlaciones molares — describen los datos pero no especifican el mecanismo que genera la sensibilidad del organismo. Killeen propone que el refuerzo no fortalece respuestas sino que induce un estado de activación general que se acopla con las respuestas disponibles. Baum propone que los organismos integran tasas de refuerzo y de respuesta a lo largo de períodos extendidos y ajustan su comportamiento a la correlación molar. Ambos modelos comparten el concepto de *inducción* — que ya introdujimos en un capítulo anterior — pero difieren en su mecanismo de aprendizaje. Ese contraste es el tema de un capítulo dedicado.
