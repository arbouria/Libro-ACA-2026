...
El ejemplo numérico mostró que el sistema converge al punto de igualación, pero se limitó a dos casos concretos. Para entender *por qué* el sistema converge desde cualquier punto de partida — y no solo en esos dos casos — necesitamos generalizar ese argumento. Al hacerlo aparece una conexión directa con el algoritmo de ascenso de colina del capítulo 4 y con los sistemas de retroalimentación negativa del capítulo 5.
