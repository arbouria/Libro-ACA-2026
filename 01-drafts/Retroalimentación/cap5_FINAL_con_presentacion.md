...
## Comparación Simultánea y el Control de la Orientación

---

## NOTA EDITORIAL: Decisiones de Revisión

Antes del capítulo, documento aquí las decisiones principales y la justificación:

**1. Estructura: de "Partes" a secciones con narrativa continua.**
El borrador completo está organizado en ocho partes con encabezados descriptivos, lo que le da un tono de manual técnico más que de libro de texto narrativo. Lo reorganicé en secciones que se encadenan como argumento, siguiendo el patrón del Cap. 4 reescrito: problema → solución → mecanismo → formalización → limitación → puente.

**2. Mariposa sin cálculo diferencial.**
La ecuación dθ/dt = -K·sin(θ) es una ecuación diferencial ordinaria que los estudiantes de licenciatura en psicología no pueden resolver formalmente. Tomé la decisión de presentar la ecuación ω = K·sin(θ) como "función de control" (que sí es álgebra accesible) y explicar cualitativamente por qué produce espirales: cuando el ángulo es grande, el giro es grande; cuando el ángulo se achica, el giro se vuelve sutil; esto produce convergencia asintótica. La idea central queda intacta sin requerir cálculo.

**3. Modelo interno: eliminado como sección.**
Lo quité conforme a la instrucción. La sección de "Componentes del modelo interno" era una excursión que pertenece mejor a un capítulo sobre planificación o control motor experto. El puente hacia el aprendizaje lo construyo directamente con el ejemplo del conductor, que es más concreto y cotidiano.

**4. El conductor como cierre.**
En lugar de terminar con una taxonomía de tipos de predicción, termino con el ejemplo del conductor en carretera desarrollado como parábola del problema adaptativo central: la retroalimentación pura es esclava del presente, y el mundo real requiere anticipación. Este cierre conecta emocionalmente con el estudiante y prepara el terreno para Pavlov sin nombrarlo todavía.

**5. Retroalimentación positiva: breve, integrada.**
El borrador dedica una sección completa a la retroalimentación positiva con lista de ejemplos. La integré como un párrafo de contraste dentro de la sección de regulación, porque pedagógicamente lo que importa es entender la negativa. La positiva merece mención, no disertación.

**6. La tabla comparativa kinesis/taxias: conservada.**
Consideré convertirla a prosa, pero decidí conservarla en formato de tabla porque es genuinamente informativa de un vistazo y porque el propio Cap. 4 ya establece las diferencias verbalmente—aquí la tabla funciona como resumen visual, no como sustituto de comprensión.

**7. Simuladores: tres propuestas integradas al texto**, marcadas con [SIMULADOR N] y código Python listo para Colab.

**8. Figuras sugeridas**: marcadas con [FIGURA N: descripción] en los puntos donde la presentación de diapositivas ya tiene ilustraciones equivalentes.
...
Imagina ser una polilla nocturna. En algún punto del espacio, a una distancia desconocida, hay una fuente de luz. No tienes mapa, no tienes distancia, no tienes brújula. Solo tienes lo que tus dos ojos detectan en este momento: dos intensidades luminosas, una para cada lado de tu cuerpo. El problema adaptativo es claro: ¿cómo usas esa información mínima para orientar tu cuerpo hacia la fuente?
...
El parámetro **k** es la *ganancia* del sistema. Una ganancia alta significa que ante una pequeña diferencia entre sensores, el organismo produce un giro grande y brusco: llega rápido a la meta, pero tiende a pasarse, generando un nuevo error en la dirección opuesta, y potencialmente oscila. Una ganancia baja significa giros lentos y suaves, raramente sobrepasa el objetivo, pero tarda más en corregirse. La ganancia es, en este sentido, la "personalidad" del controlador: nerviosismo versus calma. En fototaxia positiva, k > 0; en fototaxia negativa (como la cucaracha huyendo de la luz), k < 0.
...
*En el próximo capítulo comenzamos el Bloque I: Aprendizaje Asociativo. El primer problema: cuando múltiples eventos preceden una consecuencia, ¿cómo determina el organismo cuáles son predictivos y cuáles son accidentales?*

---

**Fin del Capítulo 5**
---verificacion---
Este archivo tiene: cuatro preguntas, bebe recien nacido, C=G(X), referencias a diapositivas
